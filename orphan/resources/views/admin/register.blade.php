...
{{ csrf_field() }}
		<div class="parentsection">
			...
			<div class="form-group{{ $errors->has('email')?' has-error':'' }}">
				    ...
				    <div class="input-group">
					   <!--  <p class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></p> -->
			...
			<div class="form-group{{ $errors->has('uimage')?' has-error':'' }}">
				...
				<label>Your photo:</label><br>
					...
					@if ($errors->has('uimage'))
		                <span class="help-block">
		                    <strong>Enter the valid image</strong>
		                </span>
	                @endif
				</div>
			</div>
		...
		<div class="parentsection">
			...
			<div class="form-group{{ $errors->has('cage')?' has-error':'' }}">
					...
					@if ($errors->has('cage'))
		                <span class="help-block">
		                    <strong>Enter the valid age</strong>
		                </span>
	                @endif
					</div>
			</div> 
			...
			<div class="form-group{{ $errors->has('sex')?' has-error':'' }}">
					...
					@if ($errors->has('sex'))
		                <span class="help-block">
		                    <strong>Check the option</strong>
		                </span>
	                @endif
			</div> 
			...
			<div class="form-group{{ $errors->has('education')?' has-error':'' }}">
				...
				<div class="input-group">
					...
					@if ($errors->has('education'))
		                <span class="help-block">
		                    <strong>Enter the valid Education Field</strong>
		                </span>
	                @endif	
				</div>
			</div>
			...
			<div class="form-group{{ $errors->has('health')?' has-error':'' }}">
				...
				<div class="input-group">
					...
					@if ($errors->has('health'))
		                <span class="help-block">
		                    <strong>Check the valid Health Field</strong>
		                </span>
	                @endif	
				</div>
			</div>
			
			<div class="form-group upload-area{{ $errors->has('cimage')?' has-error':'' }}">
				<label>Photo of Child:</label><br>
				<img class="imagePreview" alt="Upload photo">
   				 <input type='file' class="inputBrowse" id="imgInp" value="image" name="cimage"/>
   				 @if ($errors->has('cimage'))
		                <span class="help-block">
		                    <strong>Check the  Image Field</strong>
		                </span>
	             @endif	
			</div>
